...
import { SubmissionResult } from "@/theoj-api";
import { formatResult } from "./utils.mts";
...
const submissionResultColors: Record<SubmissionResult, string> = {
...
<template>
  <div class="badge" :class="submissionResultColors[result]">
    {{ formatResult(result) }}
  </div>
</template>
